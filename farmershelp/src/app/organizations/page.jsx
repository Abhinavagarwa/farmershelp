        ...
        <div>
            ...
            <div class="card-container">                
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Universal Versatile Society (UVS)</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Gramya Resource Center for Women</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Dilasa Sanstha</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Swades Foundation</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Marathwada Navnirman Lokayat (MANAVLOK)</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Watershed Organisation Trust (WOTR)</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Professional Assistance for Development Action (PRADAN)</strong><br/>
                ...
                <div class="cards">
                    ...
                    <div class="card-text">
                        <p>
                            <strong>Seven Sisters Development Assistance (SeSTA)</strong><br/>
